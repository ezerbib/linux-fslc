...
//	/* This is the edid that KDS should return */
//	0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00,		//0 - header[8] - fixed pattern
//	0x2d, 0xb2,						//8 - manufacturer_name[2]
//	0x73, 0x06,						//10 - product_code[2]
//	0xd6, 0x12, 0x00, 0x00,					//12 - serial_number[4]
//	0x16,							//16 - week
//	0x1A,							//17 - year 26+1990=2016
//	0x01,							//18 - version
//	0x03,							//19 - revision
...
//	0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x0a, 0x20, 	//"00000000000\n "
...
//	0x4b, 0x44, 0x53, 0x2d, 0x4b, 0x45, 0x4e, 0x43, 0x34, 0x0a, 0x00, 0x00,	0x00,	//"KDS-KENC4\n"
...
//	0x1d, 0x1e, 0x1f, 0x10,
//	0x23, 0x09,	0x07, 0x01,                     //AUDIO BLOCK
//	0x83, 0x01, 0x00, 0x00,			            //22
...
//	0xbf, 0xef, 0x00,					//35 - established_timings[3]
//	0x71, 0x4f, 0x81, 0x40, 0x81, 0x80, 0x95, 0x00, 0xb3, 0x00, 0xd1, 0xc0, 0x01, 0x01, 0x01, 0x01,	//38 - standard_timings[8]
	0x00, 0x00, 0x00,					//35 - established_timings[3]
	0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,	//38 - standard_timings[8]
/* 1080P60 */
	0x02, 0x3a,						//54(0) - descriptor[0], 0x3a02 = 148.50 MHz
	0x80,							//56(2) h - active 0x780 (1920)
	0x18,							//57(3) h - blank 0x118 (280)
    ...
    /* 1080P30 */
    0x02, 0x1d,						//54(0) - descriptor[0], 0x3a02 = 148.50 MHz
    0x80,							//56(2) h - active 0x780 (1920)
    0x18,							//57(3) h - blank 0x118 (280)
    0x71,							//58(4)
    0x38,							//59(5) v - active 0x438 (1080)
    ...
    0x00,							//69(15) - h border pixels
    0x00,							//70(16) - v border pixels
    0x00,							//71(17) - no stereo, digital separate, hsync+, vsync+

	0x1e, 0x00, 0x00, 0xfd, 0x00,							//90 - descriptor[2]
	0x37, 0x4b, 0x1e, 0x55, 0x10, 0x00, 0x0a, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
	0x00, 0x00, 0x00, 0xfc, 0x00, 							//108 - descriptor[3]
	0x4b, 0x44, 0x53, 0x2d, 0x45, 0x4e, 0x34, 0x0a, 0x20, 0x20,	0x20, 0x20 ,0x20,	//"KDS-EN4\n"
	0x01,							//126 - extension_flag
//	0x39,							//127 - checksum
	0xe6,							//127 - checksum
	...
	0x03,							//1 - rev 3
//	0x22,							//2 - detailed timings at offset 34
	0x17,							//2 - detailed timings at offset 29
	0x70,							//3 - # of detailed timing descriptor
//	0x4f, 0x01, 0x02, 0x03, 0x11, 0x12,			//4
//	0x13, 0x04, 0x14, 0x05, 0x0e, 0x0f,			//10
//	0x1d, 0x1e, 0x1f, 0x10,
	0x44, 0x90, 0x22, 0x04, 0x3e,			    //Video Block
	0x23, 0x09,	0x07, 0x01,                     //Audio Block
	0x83, 0x01, 0x00, 0x00,			            //Speaker Allocation
	0x65, 0x03, 0x0c, 0x00, 0x10, 0x00,			//Vendor Specific

    /* 1280x720p60 */
    0x11, 0x1d, 0x00, 0x72, 0x51, 0xd0, 0x1e, 0x20,
    0x6e, 0x28, 0x55, 0x00 ,0x09, 0x25, 0x21, 0x00, 0x00, 0x1e,

/* 1280x720p30 */
    0x91, 0x0e,                                 //47 - 0x1d01 74.25MHz
    0x00,                                       //h - active (0x500)1280
    0x72,                                       //h - blank (0x172)370
    0x51,
    0xd0,                                       //v active 0x2d0(720)
...
static const struct reg_value tc358743_setting_YUV422_2lane_60fps_720_480_125Mhz[] = {
		  {0x0006, 0x000000be, 0x00000000, 2, 0},
		  {0x000a, 0x000005a0, 0x00000000, 2, 0},
		//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
		  {0x0014, 0x00000000, 0x00000000, 2, 0},
		  {0x0016, 0x000005ff, 0x00000000, 2, 0},
		// Program CSI Tx PLL
		  {0x0020, 0x00003063, 0x00000000, 2, 0},
		  {0x0022, 0x00000613, 0x00000000, 2, 0},
		// CSI Tx PHY  (32-bit Registers)
		  {0x0140, 0x00000000, 0x00000000, 4, 0},
		  {0x0144, 0x00000000, 0x00000000, 4, 0},
		  ...
		  {0x0150, 0x00000000, 0x00000000, 4, 0},
		// CSI Tx PPI  (32-bit Registers)
		  {0x0210, 0x00000bb8, 0x00000000, 4, 0},
		  {0x0214, 0x00000002, 0x00000000, 4, 0},
		  {0x0218, 0x00000f02, 0x00000000, 4, 0},
		  {0x021c, 0x00000000, 0x00000000, 4, 0},
		  {0x0220, 0x00000003, 0x00000000, 4, 0},
		  {0x0224, 0x00004970, 0x00000000, 4, 0},
		  {0x0228, 0x00000000, 0x00000000, 4, 0},
		  {0x022c, 0x00000000, 0x00000000, 4, 0},
		  {0x0234, 0x00000007, 0x00000000, 4, 0},
		  {0x0238, 0x00000001, 0x00000000, 4, 0},
		  {0x0204, 0x00000001, 0x00000000, 4, 0},
		...
		// InfoFrame Extraction
		  ...
		  {0x854a, 0x00000001, 0x00000000, 1, 0},
		// Output Control
		  {0x0004, 0x00000cd7, 0x00000000, 2, 0},
		  };


static const struct reg_value tc358743_setting_YUV422_4lane_60fps_2880_480_216Mhz[] = {
  {0x0006, 0x0000000a, 0x00000000, 2, 0},
//  {0x000a, 0x000005a0, 0x00000000, 2, 0},
//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
  {0x0014, 0x00000000, 0x00000000, 2, 0},
  {0x0016, 0x000005ff, 0x00000000, 2, 0},
// Program CSI Tx PLL
  {0x0020, 0x0000307f, 0x00000000, 2, 0},
  {0x0022, 0x00000613, 0x00000000, 2, 0},
// CSI Tx PHY  (32-bit Registers)
  {0x0140, 0x00000000, 0x00000000, 4, 0},
  {0x0144, 0x00000000, 0x00000000, 4, 0},
...
// CSI Tx PPI  (32-bit Registers)
  ...
  {0x0218, 0x00000f02, 0x00000000, 4, 0},
  {0x021c, 0x00000000, 0x00000000, 4, 0},
  {0x0220, 0x00000002, 0x00000000, 4, 0},
  {0x0224, 0x00004970, 0x00000000, 4, 0},
  {0x0228, 0x00000000, 0x00000000, 4, 0},
  {0x022c, 0x00000001, 0x00000000, 4, 0},
  {0x0234, 0x0000001f, 0x00000000, 4, 0},
  ...
  {0x0204, 0x00000001, 0x00000000, 4, 0},
  {0x0518, 0x00000001, 0x00000000, 4, 0},
  {0x0500, 0xA3008086, 0x00000000, 4, 0},
// HDMI Interrupt Mask
  {0x8502, 0x00000001, 0x00000000, 1, 0},
  {0x8512, 0x000000fe, 0x00000000, 1, 0},
  {0x8513, 0x00000000, 0x00000000, 1, 0},
...
static const struct reg_value tc358743_setting_YUV422_2lane_60fps_800_600_80Mhz[] = {
  {0x0006, 0x000000be, 0x00000000, 2, 0},
//  {0x000a, 0x000005a0, 0x00000000, 2, 0},
//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
  {0x0014, 0x00000000, 0x00000000, 2, 0},
  {0x0016, 0x000005ff, 0x00000000, 2, 0},
// Program CSI Tx PLL
  {0x0020, 0x0000305d, 0x00000000, 2, 0},
  {0x0022, 0x00000613, 0x00000000, 2, 0},
// CSI Tx PHY  (32-bit Registers)
  {0x0140, 0x00000000, 0x00000000, 4, 0},
  {0x0144, 0x00000000, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_2lane_60fps_848_840_60Mhz[] = {
  {0x0006, 0x000000be, 0x00000000, 2, 0},
//  {0x000a, 0x000005a0, 0x00000000, 2, 0},
//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
  {0x0014, 0x00000000, 0x00000000, 2, 0},
  {0x0016, 0x000005ff, 0x00000000, 2, 0},
// Program CSI Tx PLL
  {0x0020, 0x0000308c, 0x00000000, 2, 0},
  {0x0022, 0x00000a13, 0x00000000, 2, 0},
// CSI Tx PHY  (32-bit Registers)
  {0x0140, 0x00000000, 0x00000000, 4, 0},
  {0x0144, 0x00000000, 0x00000000, 4, 0},
  {0x0148, 0x00000000, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_4lane_60fps_1280_1024_182Mhz[] = {
		  {0x0006, 0x0000000a, 0x00000000, 2, 0},
		  {0x000a, 0x000005a0, 0x00000000, 2, 0},
		//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
		  {0x0014, 0x00000000, 0x00000000, 2, 0},
		  {0x0016, 0x000005ff, 0x00000000, 2, 0},
		// Program CSI Tx PLL
		  {0x0020, 0x0000306a, 0x00000000, 2, 0},
		  {0x0022, 0x00000613, 0x00000000, 2, 0},
		// CSI Tx PHY  (32-bit Registers)
		  {0x0140, 0x00000000, 0x00000000, 4, 0},
		  {0x0144, 0x00000000, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_4lane_60fps_1600_900_216Mhz[] = {
		  {0x0006, 0x0000000a, 0x00000000, 2, 0},
		  {0x000a, 0x000005a0, 0x00000000, 2, 0},
		//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
		  {0x0014, 0x00000000, 0x00000000, 2, 0},
		  {0x0016, 0x000005ff, 0x00000000, 2, 0},
		// Program CSI Tx PLL
		  {0x0020, 0x0000307d, 0x00000000, 2, 0},
		  {0x0022, 0x00000613, 0x00000000, 2, 0},
		// CSI Tx PHY  (32-bit Registers)
		  {0x0140, 0x00000000, 0x00000000, 4, 0},
		  {0x0144, 0x00000000, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_4lane_60fps_1440_900_213Mhz[] = {
		  {0x0006, 0x0000000a, 0x00000000, 2, 0},
		  {0x000a, 0x000005a0, 0x00000000, 2, 0},
		//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
		  {0x0014, 0x00000000, 0x00000000, 2, 0},
...
static const struct reg_value tc358743_setting_YUV422_4lane_60fps_1440_480_125Mhz[] = {
  {0x0006, 0x00000032, 0x00000000, 2, 0},
  {0x000a, 0x000005a0, 0x00000000, 2, 0},
//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
  {0x0014, 0x00000000, 0x00000000, 2, 0},
  {0x0016, 0x000005ff, 0x00000000, 2, 0},
// Program CSI Tx PLL
  {0x0020, 0x00003863, 0x00000000, 2, 0},
  {0x0022, 0x00000613, 0x00000000, 2, 0},
// CSI Tx PHY  (32-bit Registers)
  {0x0140, 0x00000000, 0x00000000, 4, 0},
  {0x0144, 0x00000000, 0x00000000, 4, 0},
  ...
  {0x0150, 0x00000000, 0x00000000, 4, 0},
// CSI Tx PPI  (32-bit Registers)
  {0x0210, 0x00007d00, 0x00000000, 4, 0},
  {0x0214, 0x00000001, 0x00000000, 4, 0},
  {0x0218, 0x00000901, 0x00000000, 4, 0},
  {0x021c, 0x00000000, 0x00000000, 4, 0},
  {0x0220, 0x00000002, 0x00000000, 4, 0},
  {0x0224, 0x00004970, 0x00000000, 4, 0},
  {0x0228, 0x00000005, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_2lane_60fps_1440_480_54Mhz[] = {
  {0x0006, 0x0000000a, 0x00000000, 2, 0},
  {0x000a, 0x00000b40, 0x00000000, 2, 0},
//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
  {0x0014, 0x00000000, 0x00000000, 2, 0},
  {0x0016, 0x000005ff, 0x00000000, 2, 0},
// Program CSI Tx PLL
  {0x0020, 0x00003077, 0x00000000, 2, 0},
  {0x0022, 0x00000613, 0x00000000, 2, 0},
// CSI Tx PHY  (32-bit Registers)
  {0x0140, 0x00000000, 0x00000000, 4, 0},
  {0x0144, 0x00000000, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_4lane_60fps_1600_1200_324Mhz[] = {

		  {0x0006, 0x000000fa, 0x00000000, 2, 0},
		  {0x000a, 0x00000b40, 0x00000000, 2, 0},
		//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
		  {0x0014, 0x00000000, 0x00000000, 2, 0},
		  {0x0016, 0x000005ff, 0x00000000, 2, 0},
		// Program CSI Tx PLL
		  {0x0020, 0x0000386b, 0x00000000, 2, 0},
		  {0x0022, 0x00000213, 0x00000000, 2, 0},
		// CSI Tx PHY  (32-bit Registers)
		  {0x0140, 0x00000000, 0x00000000, 4, 0},
		  {0x0144, 0x00000000, 0x00000000, 4, 0},
		...
		// CSI Tx PPI  (32-bit Registers)
		  {0x0210, 0x00001e00, 0x00000000, 4, 0},
		  {0x0214, 0x00000004, 0x00000000, 4, 0},
		  {0x0218, 0x00001603, 0x00000000, 4, 0},
		  {0x021c, 0x00000001, 0x00000000, 4, 0},
		  {0x0220, 0x00000004, 0x00000000, 4, 0},
		  {0x0224, 0x00004a00, 0x00000000, 4, 0},
		  {0x0228, 0x00000008, 0x00000000, 4, 0},

		  {0x022c, 0x00000003, 0x00000000, 4, 0},
		  {0x0230, 0x00000005, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_4lane_60fps_1920_1200_308Mhz[] = {
		...
		//  {0x0010, 0x0000001e, 0x00000000, 2, 0},
		  ...
		  {0x0016, 0x000005ff, 0x00000000, 2, 0},
		// Program CSI Tx PLL
		  {0x0020, 0x0000305a, 0x00000000, 2, 0},
		  {0x0022, 0x00000213, 0x00000000, 2, 0},
		// CSI Tx PHY  (32-bit Registers)
		  {0x0140, 0x00000000, 0x00000000, 4, 0},
		  {0x0144, 0x00000000, 0x00000000, 4, 0},
		  ...
		  {0x0150, 0x00000000, 0x00000000, 4, 0},
		// CSI Tx PPI  (32-bit Registers)
		  {0x0210, 0x00000fa0, 0x00000000, 4, 0},
		  {0x0214, 0x00000003, 0x00000000, 4, 0},
		  {0x0218, 0x00001503, 0x00000000, 4, 0},
		  {0x021c, 0x00000000, 0x00000000, 4, 0},
		  {0x0220, 0x00000103, 0x00000000, 4, 0},
		  {0x0224, 0x00004e20, 0x00000000, 4, 0},
		  {0x0228, 0x00000000, 0x00000000, 4, 0},
...
static const struct reg_value tc358743_setting_YUV422_4lane_1366x768_50fps_158MHz[] = {
...
/***/
  ...
  {0x0016, 0x000005ff, 0x00000000, 2, 0},
// Program CSI Tx PLL
  {0x0020, 0x00003050, 0x00000000, 2, 0},	// Input divide 5(4+1), Feedback divide 92(0x5c+1)
  {0x0022, 0x00000613, 0x00000000, 2, 0},
// CSI Tx PHY  (32-bit Registers)
  {0x0140, 0x00000000, 0x00000000, 4, 0},
  {0x0144, 0x00000000, 0x00000000, 4, 0},
...
/* Color bar test settings */
	...
	[tc358743_60_fps][tc358743_mode_INIT0] =
	...
	[tc358743_30_fps][tc358743_mode_INIT0] =
...
/* Input settings */
	...
	[tc358743_60_fps][tc358743_mode_1440x480] =
		{"1440x480@60", tc358743_mode_1440x480,  1440, 480,
		8, 0x3c, 2, 54,
		tc358743_setting_YUV422_2lane_60fps_1440_480_54Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_2lane_60fps_1440_480_54Mhz),

		MIPI_DT_YUV422,
		},

	[tc358743_60_fps][tc358743_mode_720x576] =
		{"720x576@50", tc358743_mode_720x576,  720, 576,
		7, 50, 2, 54,
		tc358743_setting_YUV422_2lane_60fps_720_480_125Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_2lane_60fps_720_480_125Mhz),
	...
	[tc358743_60_fps][tc358743_mode_2880x480] =
		{"2880x480@60", tc358743_mode_2880x480,  2880, 480,
		10, 0x3c, 4, 216,
		tc358743_setting_YUV422_4lane_60fps_2880_480_216Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_4lane_60fps_2880_480_216Mhz),

		MIPI_DT_YUV422,
		},

	[tc358743_60_fps][tc358743_mode_800x600] =
		{"800x600@60", tc358743_mode_800x600,  800, 600,
		0, 0x3c, 2, 80,
		tc358743_setting_YUV422_2lane_60fps_800_600_80Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_2lane_60fps_800_600_80Mhz),

		MIPI_DT_YUV422,
		},

	[tc358743_60_fps][tc358743_mode_848x480] =
		{"848x480@60", tc358743_mode_848x480,  848, 480,
		0, 0x3c, 2, 60,
		tc358743_setting_YUV422_2lane_60fps_848_840_60Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_2lane_60fps_848_840_60Mhz),

		MIPI_DT_YUV422,
		},

	[tc358743_60_fps][tc358743_mode_1280x1024] =
		{"1280x1024@60", tc358743_mode_1280x1024,  1280, 1024,
		0, 0x3c, 4, 182,
		tc358743_setting_YUV422_4lane_60fps_1280_1024_182Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_4lane_60fps_1280_1024_182Mhz),

		MIPI_DT_YUV422,
		},

	[tc358743_60_fps][tc358743_mode_1600x900] =
		{"1600x900@60", tc358743_mode_1600x900,  1600, 900,
		0, 0x3c, 4, 216,
		tc358743_setting_YUV422_4lane_60fps_1600_900_216Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_4lane_60fps_1600_900_216Mhz),

		MIPI_DT_YUV422,
		},


	[tc358743_60_fps][tc358743_mode_1440x900] =
		{"1440x900@60", tc358743_mode_1440x900,  1440, 900,
		0, 0x3c, 4, 54,
		tc358743_setting_YUV422_4lane_60fps_1440_900_213Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_4lane_60fps_1440_900_213Mhz),

		MIPI_DT_YUV422,
		},


	[tc358743_60_fps][tc358743_mode_1600x1200] =
			{"1600x1200@60", tc358743_mode_1600x1200,  1600, 1200,
		16, 60, 4, 54,
		tc358743_setting_YUV422_4lane_60fps_1600_1200_324Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_4lane_60fps_1600_1200_324Mhz),

		MIPI_DT_YUV422,
		},

	[tc358743_60_fps][tc358743_mode_1920x1200] =
			{"1920x1200@60", tc358743_mode_1920x1200,  1920, 1200,
		0, 60, 4, 308,
		tc358743_setting_YUV422_4lane_60fps_1920_1200_308Mhz,
		ARRAY_SIZE(tc358743_setting_YUV422_4lane_60fps_1920_1200_308Mhz),

		MIPI_DT_YUV422,
		},

	[tc358743_60_fps][tc358743_mode_1366x768] =
		{"1366x768@60", tc358743_mode_1366x768,  1366, 768,
		0, 50, 4, 158,
		tc358743_setting_YUV422_4lane_1366x768_50fps_158MHz,
		ARRAY_SIZE(tc358743_setting_YUV422_4lane_1366x768_50fps_158MHz),
		MIPI_DT_YUV422
		},
};
...
int mipi_wait(void *mipi_csi2_info)
{
	...
	/* wait for mipi stable on err2 */
	for (;;) {
		mipi_reg = mipi_csi2_get_error2(mipi_csi2_info);
		mipi_reg_test2[i++] = mipi_reg;
		if (!mipi_reg)
			break;
		if (i >= 10) {
			pr_err("mipi csi2 err2 can not reveive data correctly!\n");
			//return -1;
		}
		msleep(10);
	}
		...
		enum tc358743_mode mode)
{
	...
	retval = mipi_reset(mipi_csi2_info, frame_rate, tc358743_mode_INIT0);
	if (retval)
		return retval;
	retval = set_frame_rate_mode(td, frame_rate, tc358743_mode_INIT0);
	if (retval)
		return retval;
	retval = mipi_wait(mipi_csi2_info);

	if (mode != tc358743_mode_INIT0) {
		tc358743_software_reset(sensor);
...
// clear SSI_SRCR_RXBIT0 and SSI_SRCR_RSHFD in order to push Right-justified MSB data from
	{
		...
		u32 reg = 0;
		//ssi=0x2028000;
		pr_err("%s: SSI: %08x\n", __func__, (unsigned int)ssi);
		pr_err("%s: SSI_STCCR: %08x\n", __func__, (unsigned int)&ssi->stccr);
		pr_err("%s: SSI_SRCCR: %08x\n", __func__, (unsigned int)&ssi->srccr);
		reg = readl(&ssi->stccr);
		pr_err("%s: SSI_STCCR before: %p\n", __func__, (void *)reg);
		reg &= ~CCSR_SSI_SxCCR_WL_MASK;
		reg |= CCSR_SSI_SxCCR_WL(16);
		writel(reg, &ssi->stccr);
		pr_err("%s: SSI_STCCR after:  %p\n", __func__, (void *)reg);

		reg = readl(&ssi->srccr);
		pr_err("%s: SSI_SRCCR before: %p\n", __func__, (void *)reg);
		reg &= ~CCSR_SSI_SxCCR_WL_MASK;
		reg |= CCSR_SSI_SxCCR_WL(16);
		writel(reg, &ssi->srccr);
		pr_err("%s: SSI_SRCCR after:  %p\n", __func__, (void *)reg);
	}
#endif
	return 0;
}
...
#if 0
static int imx_tc358743_dai_init(struct snd_soc_pcm_runtime *rtd)
{
...
//SOC_DAPM_ENUM("Capture Mux", NULL);

static const struct snd_soc_dapm_widget imx_tc358743_dapm_widgets[] = {
#if 0
...
static struct snd_soc_card imxpac_tc358743 = {
	...
	.dapm_widgets	= imx_tc358743_dapm_widgets,
	.num_dapm_widgets = ARRAY_SIZE(imx_tc358743_dapm_widgets),
...
static int imx_tc358743_probe(struct platform_device *pdev)
{
	...
	//imxpac_tc358743.dapm_widgets = imx_tc358743_dapm_widgets;
	//imxpac_tc358743.num_dapm_widgets = ARRAY_SIZE(imx_tc358743_dapm_widgets);

	snd_soc_of_parse_audio_routing(&imxpac_tc358743, "audio-routing");
...
static const struct snd_soc_dapm_widget sgtl5000_dapm_widgets[] = {
	...
	//SND_SOC_DAPM_ADC("ADC", "Capture", 0, 1, 0),
#endif
...
static const struct tc_mode_list tc358743_mode_list[] =
{
	...
	{"W240p/480i", 0},							/* 4 */
	{"W288p/576i", 0},							/* 5 */
	{"480p", tc358743_mode_480P_720_480},		/* 6 */
	{"576p", tc358743_mode_720x576},			/* 7 */
	{"W480p", tc358743_mode_1440x480},			/* 8 */
	{"W576p", 0},								/* 9 */
	{"WW480p", tc358743_mode_2880x480},			/* 10 */
	{"WW576p", 0},								/* 11 */
